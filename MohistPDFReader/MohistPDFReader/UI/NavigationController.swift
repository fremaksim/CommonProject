...
public class NavigationController: UIViewController {
    ...
    public override var preferredStatusBarStyle: UIStatusBarStyle {
        ...
        if  rootTabBarController is HomeViewController ||
            childNavigationController.topViewController is HomeViewController ||
            childNavigationController.topViewController is DiscoveryViewController ||
            childNavigationController.topViewController is DiscoveryViewController ||
            childNavigationController.topViewController is ProfileViewController
        {
